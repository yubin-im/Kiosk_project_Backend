...
public interface OrderListRepository extends JpaRepository<OrderList, Long> {
    ...
    // 주문 금액 통계 - 해당 월
    @Query(value = "SELECT date(OL.ORDER_LIST_TIME) as orderListDate, SUM(OL.ORDER_LIST_TOTAL_PRICE) as totalPrice " +
            "FROM order_list OL " +
    ...
    // 주문 금액 통계 - 해당 년도
    @Query(value = "SELECT MONTH(OL.ORDER_LIST_TIME) as orderListDate, SUM(OL.ORDER_LIST_TOTAL_PRICE) as totalPrice " +
            "FROM order_list OL " +
